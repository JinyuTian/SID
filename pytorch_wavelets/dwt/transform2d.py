...
class DWTForward(nn.Module):
    ...
    Args:
        ...
        """
    def __init__(self, J=1, wave='db1', mode='zero',Requirs_Grad=False):
        super().__init__()
        ...
        self.h0_col = nn.Parameter(filts[0], requires_grad=Requirs_Grad)
        self.h1_col = nn.Parameter(filts[1], requires_grad=Requirs_Grad)
        self.h0_row = nn.Parameter(filts[2], requires_grad=Requirs_Grad)
        self.h1_row = nn.Parameter(filts[3], requires_grad=Requirs_Grad)
        self.J = J
        self.mode = mode
